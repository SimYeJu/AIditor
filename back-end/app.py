...
def initt():
    ...
    additional_tags = [
    ['none'],
    ['벚꽃놀이', '일상', '데일리', 'daily', '벚꽃스타그램','감성', '인스타감성', '맞팔', '선팔'],
    ['일상', '데일리', 'daily', '책','감성', '인스타감성', '맞팔', '선팔'],
    ['풍경', '일상', '데일리', 'daily', '노을스타그램','감성', '인스타감성', '맞팔', '선팔'],
    ['회식', '먹스타', '일상', '데일리', 'daily', '먹스타그램','감성', '인스타감성', '맞팔', '선팔'],
    ['여행스타그램', '여행', 'travel', '일상', '데일리', 'daily','감성', '인스타감성', '맞팔', '선팔'],
    ['셀피', '셀카', '셀스타그램', 'selfie', '일상', '데일리', 'daily','감성', '인스타감성', '맞팔', '선팔'],
    ['육아스타그램', '도치맘', '육아기록', '육아소통', '베이비스타그램', '인스타베이비','감성', '인스타감성', '맞팔', '선팔'],
    ['신나는파티', '일상', '데일리', 'daily','감성', '인스타감성', '맞팔', '선팔'],
    ['집스타그램', '일상', '데일리', 'daily', '하우스그램','감성', '인스타감성', '맞팔', '선팔'],
    ['공부', '공스타', '일상', '데일리', 'daily', '동기부여', '공부기록', '공스타맞팔', '필기','감성', '인스타감성', '맞팔', '선팔'],
    ['호텔', '또가고싶다', '휴가', '여행', '일상', '데일리', 'daily','감성', '인스타감성', '맞팔', '선팔'],
    ['캣스타그램', '냥스타', '고양이', 'cat', '일상', '데일리', 'daily', '집사의하루', '냥이', '야옹이', '집사', '캣스타','감성', '인스타감성', '맞팔', '선팔'],
    ['풍경', '풍경사진', '야경맛집', '야경사진', '경치', '일상', '데일리', 'daily','감성', '인스타감성', '맞팔', '선팔'],
    ['데이트스타그램', '럽스타그램', '커플', '럽스타', '커플스타그램','감성', '인스타감성', '맞팔', '선팔'],
    ['셀피', '얼스타그램', 'selfie', '셀스타그램', '데일리', '일상', 'daily', '선팔', '맞팔', '소통', 'selstagram'],
    ['dailylook', '코디', '데일리코디', '옷스타그램', '데일리룩코디', '오늘의코디', '패션', '일상', '데일리', 'daily','감성', '인스타감성', '맞팔', '선팔'],
    ['운동스타그램', '운동그램', '헬창', '헬스타그램', '헬스스타그램', '데일리', '일상', 'daily','감성', '인스타감성', '맞팔', '선팔'],
    ['술', '술스타', '안주맛집', '일상', '데일리', 'daily','감성', '인스타감성', '맞팔', '선팔'],
    ['졸업', '행복한하루', '일상', '데일리', 'daily','감성', '인스타감성', '맞팔', '선팔']
    ]
...
def faces():
    ...
    try:
        ...
        return jsonify({ "response": "no faces"}), 404
    try:
        return jsonify({
            "response": result,
    #        "response2": result2,
...
def get_images():
    ...
    for i in range(0, r["rois"].shape[0]):
        ...
        img = np.array(img)
        img_origin_w = img.shape[1]
        img = imutils.resize(img, width=512)
        img_resized_w = img.shape[1]

        img[...,3] = img[...,3] * mask

        (startY, startX, endY, endX) = r["rois"][i]
        view_img = img[startY:endY, startX:endX,:]
        img = imutils.resize(img, width=img_origin_w)

        img_w_ratio = float(img_origin_w / img_resized_w)
        view_resized_w = int(img_w_ratio * view_img.shape[1])
        view_img = imutils.resize(view_img, width=view_resized_w)
